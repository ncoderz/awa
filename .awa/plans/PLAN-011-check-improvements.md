...
- 001 (2026-03-02): Initial plan covering five real-world traceability gaps
- 002 (2026-03-02): Simplified config — all checks ON by default, no per-check toggles, only `--spec-only` controls scope
- 003 (2026-03-02): Correct severity model — spec ↔ spec = error, spec ↔ code = warning (promoted to error unless --allow-warnings)
- 004 (2026-03-02): G2 changed from matrix check to matrix generation via --fix; added TASK file matrix generation; removed matrix finding codes; updated DESIGN/TASK schemas
- 005 (2026-03-02): Inverted --fix default — fix is now default, --no-fix to skip
