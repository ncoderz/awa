...
### DIFF-8: Delete-Listed File Reporting [MUST]

AS A developer, I WANT to see which target files are listed for deletion in the template's delete list, SO THAT I can identify stale files that would be cleaned up.

> Enables awareness of stale files during diff without modifying the target.
