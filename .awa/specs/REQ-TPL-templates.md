...
This document defines requirements for the awa CLI template system, including template source resolution (local and Git), template rendering with conditional logic, and partial composition for shared content.
