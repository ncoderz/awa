# Zen CLI Design - Properties & Testing

> VERSION: 2.1.0 | STATUS: draft | UPDATED: 2025-12-17

This document contains correctness properties, error handling, and testing strategy for Zen CLI.
...
- TPL_P-2 [Empty Marker]: Template containing only `<!-- ZEN:EMPTY_FILE -->` creates an empty file
...
// @zen-test: GEN_P-1 (Underscore Exclusion)
...
// @zen-test: GEN_P-5 (Content Identity Skip)
...
// @zen-test: DIFF_P-1 (Diff Read-Only)
...
// @zen-test: DIFF_P-2 (Temp Cleanup Guaranteed)
...
// @zen-test: DIFF_P-3 (Exact Comparison)
...
// @zen-test: DIFF_P-4 (Exit Code Semantics)
...
// @zen-test: FP_P-1 (Preset Validation)
...
// @zen-test: FP_P-2 (Feature Resolution Order)
...
// @zen-test: FP_P-3 (Feature Deduplication)
...
// @zen-test: FP_P-5 (Silent Removal)
...
- AREAS: CFG-ConfigLoader merge logic, TPL-TemplateResolver type detection, TPL-TemplateEngine empty detection, GEN-ConflictResolver prompt logic
